  ...
  return (
    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <h2 className="text-3xl font-bold mb-4">Poweful Feature for your Career Growth</h2>
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          <div className="flex flex-col items-center justify-center space-y-2">
            ...
            <p className="text-muted-foreground">Industris covered</p>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <blockquote>
                    <p className="text-muted-foreground italic relative">
                      <span className="text-3-xl text-primary absolute -top-4 -left-2">
                        &quot;
                      </span>
                      {item.quote}
                      <span className="text-3-xl text-primary absolute -bottom-4">
                        &quot;
                      </span>
                    </p>
                  </blockquote>
    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <p className="text-muted-foreground">Find ansswers to common qustions about our platform</p>
        </div>
